...
INSERT INTO `user` (`user_id`, `firstname`, `lastname`, `username`, `username2`, `birthday`, `gender`, `num`, `email`, `email2`, `password`, `password2`, `profile_picture`, `cover_picture`) VALUES
