	...
	<div id="container">
		...
		<fieldset class="sign-up-form-1">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					...
					<td><input type="text" name="num" placeholder="09...." maxlength="13" class="form-1" title="Enter your mobile number" required /></td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="sign-up-form-1">
			...
			<table cellpadding="5" cellspacing="5">
				...
				<tr>
					<td><input type="password" name="pwd" placeholder="Enter your password....." class="form-1" title="Enter your username" required /></td>
		...
		<br />
					<center><input type="submit" name="submit" value="I Agree - Continue" class="btn-sign-in" title="Log in" />
		</form>
