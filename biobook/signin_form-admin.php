...
<body>
	...
	<center><div id="container">
		<div class="sign-in-form">
			...
			<h1>Biobook - Admin</h1>
			<h2>Log in</h2>
	<form method="post" action="admin-signin.php" enctype="multipart/form-data">
				<tr>
				...
				<tr>
					...
					<td><input type="password" name="pwd" placeholder="~~~~~~~~~~" class="form-1" title="Enter your password" required /></td>
				</tr>
				<tr>
					<td></td>
					<td></td>
